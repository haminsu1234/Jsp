            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" id="btnCheckUid"><img src="/Farmstory2/user/images/chk_id.gif" alt=""></button>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            ...
                            <button type="button" class="btnZip" onclick="zipcode()"><img src="/Farmstory2/user/images/chk_post.gif" alt="가나다"></button>
                        </div>                            
                        <div>
