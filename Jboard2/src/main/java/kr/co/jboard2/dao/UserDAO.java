...
public class UserDAO extends DBHelper {
	...
	public int upadtePass(String uid, String pass) {
		int result=0;
		try {
			conn=getConnection();
	...
	public int updateUserForWithraw(String uid) {
		...
		try {
			conn=getConnection();
			psmt=conn.prepareStatement(SQL.UPDATE_USER_FOR_WITHRAW);
			psmt.setString(1, uid);
	...
	public int selectCountNameAndEmail(String email,String name) {
		...
		try {
			conn=getConnection();
			psmt=conn.prepareStatement(SQL.SELECT_COUNT_EMAIL_AND_NAME);
			psmt.setString(1, email);
	...
	public int selectCountUidAndEmail(String email,String uid) {
		...
		try {
			conn=getConnection();
			psmt=conn.prepareStatement(SQL.SELECT_COUNT_EMAIL_AND_UID);
			psmt.setString(1, email);
			psmt.setString(2, uid);
	...
	public UserDTO selectUserByUidAndEmail(String uid,String email) {
		...
		try {
			...
			psmt=conn.prepareStatement(SQL.SELECT_USER_UID_EMAIL);
			psmt.setString(1, uid);
			psmt.setString(2, email);
