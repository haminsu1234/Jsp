...
public class MyInfoController extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6589873585116374224L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		switch(kind) {
		case "WITHDRAW":
			int result1 = service.updateUserForWithraw(uid);
			...
			break;
		case "PASSWORD":
			int result2 = service.updatePass(uid, pass);
