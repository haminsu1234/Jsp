	...
	<script>
				...
				if(isPassOk && confirm('정말 비밀번호를 수정하시겠습니까?')){
					...
					fetch('/Jboard2/user/myInfo.do',{
						...
						.then((data)=>{
								...
								if(data.result > 0){
									alert('비밀번호가 수정되었습니다. 다시로그인 해주세요');
									location.href = '/Jboard2/user/logout.do';
								}
						});
				}else{
					alert('변경비밀번호가 유효하지않거나 일치하지 않습니다');
				}
        ...
        <main id="user">
            <section class="myInfo">
                <form  id="formMyInfo" action="/Jboard2/user/myInfo.do" method="post">
                    ...
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button"><img src="../img/chk_post.gif" alt="우편번호찾기" onclick="zipcode()"/></button>
