...
<div id="user">
      <section class="register">
        <form id="formUser" action="/Farmstory1/Farmstory/user/registerProc.jsp" method="post">
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" id="btnCheckUid"><img src="/Farmstory1/Farmstory/user/images/chk_id.gif" alt=""></button>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            ...
                            <button type="button" class="btnZip" onclick="zipcode()"><img src="/Farmstory1/Farmstory/user/images/chk_post.gif" alt="가나다"></button>
                        </div>                            
                        <div>
            ...
            <div>
                <a href="/Farmstory1/Farmstory/user/login.jsp" class="btnCancel">취소</a>
