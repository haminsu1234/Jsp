...
<%
	...
	//로그인 여부확인
	if(sessUser==null){
		response.sendRedirect("/Farmstory1/Farmstory/user/login.jsp?errorCode=101");
		return;
	}
	...
	$(function(){
		...
		$('#btnShopping').click(function(e){
			...
			if(confirm("주문을 취소하시겠습니까?")){
				location.href='/Farmstory1/Farmstory/market/list.jsp'
			}
        ...
        <div id="sub">
            ...
            <section class="market">
                <aside>
                    ...
                    <ul class="lnb">
                        <li class="on"><a href="/Farmstory1/Farmstory/market/list.jsp">장보기</a></li>
                    </ul>
                </aside>
                <article class="order">
                    <nav>
                    ...
                    <h3>주문상품 확인</h3>
                    <div class="info">
                        <img src="/Farmstory1/Farmstory/thumb/<%= thumb2 %>" alt="<%= pName %>>">
                    ...
                    <h3>주문정보 입력</h3>
                    <div class="shipping">
                     	<form id="formOrder" action="/Farmstory1/Farmstory/market/proc/orderProc.jsp" method="post">
                        <table>
                            ...
                            <tr>
                                <td>배송주소</td>
                                <td>
                                    <input type="text" name="zip" readonly value="<%= sessUser.getZip()%>"><button id="btnZip" class="btnZip" onclick="zipcode()">우편번호 검색</button>
