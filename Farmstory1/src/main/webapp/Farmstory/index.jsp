...
<%
	...
	List<ArticleDTO> lates1 =dao.selectNewArticle("grow",5);
	List<ArticleDTO> lates2 =dao.selectNewArticle("school",5);
	List<ArticleDTO> lates3 =dao.selectNewArticle("story",5);

	List<ArticleDTO> tabs1 =dao.selectNewArticle("notice",3);
	List<ArticleDTO> tabs2 =dao.selectNewArticle("qna",3);
	List<ArticleDTO> tabs3 =dao.selectNewArticle("faq",3);
...
<<<<<<< HEAD
                    ...
                    <%for(ArticleDTO lates :lates1){ %>
                        <tr>
                            <td>></td>
                            <td><a href="/Farmstory1/Farmstory/board/view.jsp?group=Croptalk&cate=grow&no=<%= lates.getNo() %>"><%= lates.getTitle() %></a></td>
                            <td><%= lates.getRdate() %></td>
                        </tr>
                    <% } %>
                    </table>
...
<<<<<<< HEAD
                    ...
                    <%for(ArticleDTO lates :lates2){ %>
                        <tr>
                            <td>></td>
                            <td><a href="/Farmstory1/Farmstory/board/view.jsp?group=Croptalk&cate=school&no=<%= lates.getNo() %>"><%= lates.getTitle() %></a></td>
                            <td><%= lates.getRdate() %></td>
                        </tr>
                     <% } %>
                    </table>
...
<<<<<<< HEAD
                    ...
                    <%for(ArticleDTO lates :lates3){ %>
                        <tr>
                            <td>></td>
                            <td><a href="/Farmstory1/Farmstory/board/view.jsp?group=Croptalk&cate=story&no=<%= lates.getNo() %>"><%= lates.getTitle() %></a></td>
                            <td><%= lates.getRdate() %></td>
                        </tr>
                   <% } %>
                    </table>
