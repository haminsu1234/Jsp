        ...
        <div id="sub">
            ...
            <section class="croptalk">
                <aside>
                    ...
                    <ul class="lnb">
                        <li class="on"><a href="/Farmstory1/Farmstory/croptalk/story.jsp">농작물이야기</a></li>
                        <li><a href="/Farmstory1/Farmstory/croptalk/grow.jsp">텃밭가꾸기</a></li>
                        <li><a href="/Farmstory1/Farmstory/croptalk/school.jsp">귀농학교</a></li>
                    </ul>
